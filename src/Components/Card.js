...
const Card = ({title, workout_title, image, popularity, score_type, workout}) => (
    <div className="post-module hover animated fadeIn">
      <div className="thumbnail">
        <div className="date">
          <div className="day">
						<span><i className="fa fa-thumbs-o-up"></i><br/> {popularity}</span>
					</div>
				</div>
...
Card.propTypes = {
  title: React.PropTypes.string.isRequired,
	...
	popularity: React.PropTypes.string,
